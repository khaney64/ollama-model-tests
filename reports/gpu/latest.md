...
| Model | agentic-chat (ctx-10240) | agentic-chat (ctx-16384) | agentic-chat (ctx-32768) | agentic-chat (ctx-8192) | agentic (ctx-10240) | agentic (ctx-16384) | agentic (ctx-8192) | api (ctx-10240) | api (ctx-16384) | api (ctx-8192) | engine (ctx-10240) | engine (ctx-16384) | engine (ctx-8192) | refactor (ctx-10240) | refactor (ctx-16384) | refactor (ctx-8192) |
|-------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
...
| Model | Size (GB) | agentic-chat (ctx-10240) | agentic-chat (ctx-16384) | agentic-chat (ctx-32768) | agentic-chat (ctx-8192) | agentic (ctx-10240) | agentic (ctx-16384) | agentic (ctx-8192) | api (ctx-10240) | api (ctx-16384) | api (ctx-8192) | engine (ctx-10240) | engine (ctx-16384) | engine (ctx-8192) | refactor (ctx-10240) | refactor (ctx-16384) | refactor (ctx-8192) |
|-------|-----------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
...
| `hf.co/unsloth/gpt-oss-20b-GGUF:Q5_K_M` | 11.7 | - | - | 11474.0 | - | - | 11636.0 | - | - | 11625.0 | - | - | 11629.0 | - | - | 11698.0 | - |
| `hf.co/unsloth/gpt-oss-20b-GGUF:Q4_K_M` | 11.6 | - | - | 11420.0 | - | - | 11720.0 | - | - | 11536.0 | - | - | 11666.0 | - | - | 11573.0 | - |
...
3. `qwen3:14b` - 29.09 tok/s
4. `glm-4.7-flash:q4_K_M` - 13.78 tok/s

### Agentic-Chat (ctx-16384)

1. `llama3.2:latest` - 177.38 tok/s
2. `qwen3:8b` - 73.32 tok/s
3. `qwen3:14b` - 23.29 tok/s
4. `glm-4.7-flash:q4_K_M` - 12.82 tok/s

### Agentic-Chat (ctx-32768)

1. `llama3.2:latest` - 178.76 tok/s
2. `qwen2.5-coder:7b` - 93.76 tok/s
3. `qwen2.5-coder:7b-instruct-q5_K_M` - 82.41 tok/s
4. `qwen3:8b` - 70.74 tok/s
5. `llama3.1:8b` - 36.81 tok/s
6. `llama3.1:8b-instruct-q4_K_M` - 36.16 tok/s
7. `mistral:7b-instruct-v0.3-q5_K_M` - 33.58 tok/s
8. `qwen3:14b` - 10.55 tok/s
9. `glm-4.7-flash:q4_K_M` - 8.68 tok/s
10. `qwen2.5-coder:14b-instruct-q4_K_M` - 8.65 tok/s
